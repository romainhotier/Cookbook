...
class GetRecipeForIngredient(unittest.TestCase):
    ...
    def test_0_api_ok(self):
        ...
        self.assertNotIn(tc_link12.get_stringify(), response_body[api.rep_data])
        self.assertIn(tc_link21.get_stringify(), response_body[api.rep_data])
    ...
    def test_3_with_title_string_true(self):
        ...
        self.assertEqual(response_body[api.rep_code_status], 200)
        self.assertEqual(response_body[api.rep_code_msg], api.rep_code_msg_ok)
        self.assertIn(tc_link1.add_title().get_stringify(), response_body[api.rep_data])
        self.assertIn(tc_link2.add_title().get_stringify(), response_body[api.rep_data])
