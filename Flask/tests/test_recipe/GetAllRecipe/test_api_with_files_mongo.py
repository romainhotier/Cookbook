...
class GetAllRecipe(unittest.TestCase):
    ...
    def test_with_files_mongo_without(self):
        ...
        """ files recipes """
        tc_recipe1.add_file_mongo_recipe(filename="qa_rhr_1", is_main=True)
        tc_recipe1.add_file_mongo_recipe(filename="qa_rhr_2", is_main=False)
        tc_recipe2.add_file_mongo_recipe(filename="qa_rhr_3", is_main=False)
        """ files steps """
        tc_recipe1.add_file_mongo_step(_id_step="111111111111111111111111", filename="qa_rhr_11", is_main=False)
        tc_recipe1.add_file_mongo_step(_id_step="222222222222222222222222", filename="qa_rhr_21", is_main=False)
        tc_recipe1.add_file_mongo_step(_id_step="222222222222222222222222", filename="qa_rhr_22", is_main=True)
        tc_recipe2.add_file_mongo_step(_id_step="333333333333333333333333", filename="qa_rhr_31", is_main=True)
        tc_recipe2.add_file_mongo_step(_id_step="333333333333333333333333", filename="qa_rhr_32", is_main=False)
        """ call api """
    ...
    def test_with_files_mongo_true(self):
        ...
        """ files recipes """
        tc_file_recipe1 = tc_recipe1.add_file_mongo_recipe(filename="qa_rhr_1", is_main=True)
        tc_file_recipe1_bis = tc_recipe1.add_file_mongo_recipe(filename="qa_rhr_2", is_main=False)
        tc_file_recipe2 = tc_recipe2.add_file_mongo_recipe(filename="qa_rhr_3", is_main=False)
        """ files steps """
        tc_file_step1 = tc_recipe1.add_file_mongo_step(_id_step="111111111111111111111111", filename="qa_rhr_11",
                                                       is_main=False)
        tc_file_step2 = tc_recipe1.add_file_mongo_step(_id_step="222222222222222222222222", filename="qa_rhr_21",
                                                       is_main=False)
        tc_file_step2_bis = tc_recipe1.add_file_mongo_step(_id_step="222222222222222222222222", filename="qa_rhr_22",
                                                           is_main=True)
        tc_file_step3 = tc_recipe2.add_file_mongo_step(_id_step="333333333333333333333333", filename="qa_rhr_31",
                                                       is_main=True)
        tc_file_step3_bis = tc_recipe2.add_file_mongo_step(_id_step="333333333333333333333333", filename="qa_rhr_32",
                                                           is_main=False)
        """ param """
