...
class GetAllRecipe(unittest.TestCase):
    ...
    def test_with_files_without(self):
        ...
        """ files steps """
        tc_recipe1.add_file_step(_id_step="111111111111111111111111", filename="qa_rhr_11", is_main=False)
    ...
    def test_with_files_true(self):
        ...
        self.assertEqual(response_body["codeMsg"], api.rep_code_msg_ok)
        """ data recipe 1 """
        formated_data1 = api.data_expected(recipe=tc_recipe1, files=[tc_file_recipe1, tc_file_recipe1_bis])
        formated_data1.add_ingredient_files(ingredient=tc_ingredient1, files=[tc_file_ingredient1,
                                                                              tc_file_ingredient1_bis])
        formated_data1.add_ingredient_files(ingredient=tc_ingredient2, files=[tc_file_ingredient2])
        formated_data1.add_steps_files(_id="111111111111111111111111", files=[tc_file_step1])
        formated_data1.add_steps_files(_id="222222222222222222222222", files=[tc_file_step2, tc_file_step2_bis])
        """ data recipe 2 """
        formated_data2 = api.data_expected(recipe=tc_recipe2, files=[tc_file_recipe2])
        formated_data2.add_ingredient_files(ingredient=tc_ingredient2, files=[tc_file_ingredient2])
        formated_data2.add_steps_files(_id="333333333333333333333333", files=[tc_file_step3, tc_file_step3_bis])
        """ assert data """
