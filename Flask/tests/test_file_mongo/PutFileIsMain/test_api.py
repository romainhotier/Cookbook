...
import utils
import tests.test_file_mongo.PutFileIsMain.api as api
...
class PutFileIsMain(unittest.TestCase):
    ...
    def test_api_ok(self):
        ...
        """
        """ env """
        tc_file1 = file_model.FileMongoTest().custom({"metadata": {"kind": "kind_file",
                                                                   "_id_parent": ObjectId("111111111111111111111111"),
                                                                   "is_main": True}}).insert()
        tc_file2 = file_model.FileMongoTest().custom({"metadata": {"kind": "kind_file",
                                                                   "_id_parent": ObjectId("111111111111111111111111"),
                                                                   "is_main": False}}).insert()
        tc_file3 = file_model.FileMongoTest().custom({"metadata": {"kind": "kind_file",
                                                                   "_id_parent": ObjectId("111111111111111111111111"),
                                                                   "is_main": False}}).insert()
        tc_file4 = file_model.FileMongoTest().custom({"metadata": {"kind": "kind_file",
