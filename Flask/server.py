...
def not_found(error):
    """" abort 404 """
    body = factory.ServerResponse().return_response(data=error.description, api="cookbook", code=404)
...
def method_not_allowed(error):
    """" abort 405 """
    body = factory.ServerResponse().return_response(data=error.description, api="cookbook", is_mongo=False, code=405)
