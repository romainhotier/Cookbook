...
class FileMongo(object):
    ...
    @staticmethod
    def select_one(_id):
        """ Get a FileMongo by it's ObjectId.

        Parameters
        ----------
        _id : str
            FileMongo's ObjectId.
    ...
    def get_all_file_by_id_parent(self, _id_parent):
        """ Get all FilesMongo for a parent.
    ...
    def clean_file_by_id_parent(_id_parent):
        """ Delete all FilesMongo associated to a parent.
    ...
    def erase_is_main_if_exist(_id_parent):
        """ Set is_main to False if there was a primary FileMongo.
