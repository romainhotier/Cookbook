...
def post_recipe_step(_id):
    ...
    return factory.ServerResponse().return_response(data=inserted, api="recipe_steps", code=201)
...
def delete_recipe_step(_id, position):
    ...
    return factory.ServerResponse().return_response(data=deleted, api="recipe_steps", code=200)
