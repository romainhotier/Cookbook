...
class PutFileIsMain(unittest.TestCase):
    ...
    def test_0_api_ok(self):
        tc_file1 = file_model.FileTest().custom_metadata({"kind": "kind_file",
                                                          "_id": ObjectId("111111111111111111111111"),
                                                          "is_main": True}).insert()
        tc_file2 = file_model.FileTest().custom_metadata({"kind": "kind_file",
                                                          "_id": ObjectId("111111111111111111111111"),
                                                          "is_main": False}).insert()
        tc_file3 = file_model.FileTest().custom_metadata({"kind": "kind_file",
                                                          "_id": ObjectId("111111111111111111111111"),
                                                          "is_main": False}).insert()
        tc_file4 = file_model.FileTest().custom_metadata({"kind": "kind_file",
        ...
        tc_file3.custom_metadata({"is_main": True})
        """ assert """
